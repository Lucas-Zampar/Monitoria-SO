...
#include<Adafruit_BMP280.h> // Inclui a biblioteca do sensor
...
// Instância o objeto responsável por realizar a leitura da temperatura e da pressão
Adafruit_BMP280 bmp;

// Declara variáveis responsáveis por armazenar os valores de temperatura e pressão
float temperatura;
float pressao;
